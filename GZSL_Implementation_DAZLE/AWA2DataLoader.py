...
dataset = 'AWA2'
img_dir = os.path.join(NFS_path,'Animals_with_Attributes2/')
mat_path = os.path.join(NFS_path,'data/xlsa17/data/{}/res101.mat'.format(dataset))
attr_path = 'C:/Sushree/Jio_Institute/Dataset/data/attribute/{}/new_des.csv'.format(dataset)
feature_path = os.path.join(NFS_path,'Animals_with_Attributes2/')


class AWA2DataLoader():
    def __init__(self, data_path, feature_path, device = None, is_scale = False, is_balance =True):
        ...
        self.read_matdataset(feature_path)
        self.get_idx_classes()
        
#data_path = 'C:/Sushree/Jio_Institute/Dataset/'
#datadir = 'C:/Sushree/Jio_Institute/Dataset/data/AWA2/'
#img_dir = 'C:/Sushree/Jio_Institute/Dataset/data/AWA2/'
#path = 'C:/Sushree/Jio_Institute/Dataset/data/AWA2/feature_map_ResNet_101_AWA2.hdf5''
#actual path = "C:\Sushree\Jio_Institute\Dataset\Animals_with_Attributes2"

    def augment_img_path(self,mat_path=mat_path, feature_path = feature_path, img_dir=img_dir):
        ...
        path = self.feature_path + 'feature_map_ResNet_101_{}.hdf5'.format(self.dataset)
        hf = h5py.File(path, 'r')
    ...
    def read_matdataset(self, feature_path):
