...
attr_path = 'C:/Sushree/Jio_Institute/Dataset/CUB_200_2011/CUB_200_2011/attributes/new_des.csv'
feature_path = os.path.join('C:/Sushree/Jio_Institute/Dataset/CUB_200_2011/CUB_200_2011/')
...
class CUBDataLoader():
    ...
    def augment_img_path(self,mat_path=mat_path,img_dir=img_dir):
        ...
        path= self.feature_path + 'feature_map_ResNet_101_CUB.hdf5'
        hf = h5py.File(path, 'r')
