...
from helper_func import mix_up
#%%
import pdb
#%%

NFS_path = 'C:/Sushree/Jio_Institute/Dataset/'
img_dir = os.path.join(NFS_path,'data/SUN/')
mat_path = os.path.join(NFS_path,'data/xlsa17/data/SUN/res101.mat')
attr_path = 'C:/Sushree/Jio_Institute/Dataset/SUNAttributeDB_Images/attribute/new_des.csv'
feature_path = os.path.join('C:/Sushree/Jio_Institute/Dataset/SUNAttributeDB_Images/')
...
#        return Y,S,None
    ...
    def read_matdataset(self):
        ...
        path= self.feature_path + 'feature_map_ResNet_101_SUN.hdf5'
        print('_____')
        print(path)
        #tic = time.clock()
        hf = h5py.File(path, 'r')
